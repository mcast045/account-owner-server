...
namespace AccountOwnerServer.Controllers
{
    ...
    public class OwnerController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> CreateOwner([FromBody]Owner owner) //Data is coming from body 
        {
            try
            {
        ...
        public async Task<IActionResult> DeleteOwner(Guid id)
        {
            try
            {
                ...
                {
                    _logger.LogError("Cannot delete owner with id {id}. Please delete related accounts first");
                    return BadRequest("Cannot delete owner with id {id}. Please delete related accounts first");
                }
